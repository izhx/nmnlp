"""
Functions and exceptions for checking basic config of tjunlp.
"""
...
class ConfigurationError(Exception):
    """
    The exception raised by any tjunlp object when it's configured wrong
    (e.g. missing, invalid or unknown properties).
    """
